...
class JEDEC_PDF(FPDF):
    ...
    def create_table(self, df):
        ...
        for _, row in df.iterrows():
            # Synchronized Row Height Calculation
            ...
            # Locked height for first 3 columns
            ...
            # Wrapped height for Significance column
...
st.markdown("Automated validation of silicon parameters against **JESD79-4B**.")
st.divider()
