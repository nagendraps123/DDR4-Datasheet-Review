...
if uploaded_file:
    ...
    # 5. TECHNICAL TABS
    # -----------------------------------------------------
    tabs = st.tabs(["🏗️ Architecture", "⚡ DC Power", "🕒 SI & Clocking", 
                    "⏱️ AC Timings", "🌡️ Thermal/Refresh", "🛡️ RAS/Integrity"])
    ...
    <div class="link-container">
        ...
        <p style="font-size: 13px; color: #64748b;">
            ...
            <a href="https://www.jedec.org/standards-documents/docs/jesd79-4b" target="_EC JESD79-4B (DDR4 SDRAM)
            </a>
        </p>
    </div>
    """, unsafe_allow_html=True)
